...
{
    public partial class HosoSv : Form
    {
        public HosoSv()
        {
            InitializeComponent();
        ...
        private void buttonLuu_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var rs = new Connection().SelectRow("[dbo].[ProcSinhVienUpdate]", lstPara);
                if (rs.ItemArray[0].ToString() == "1")
                {
                ...
                {
                    MessageBox.Show("Something error", rs.ToString());
                }
            }    
            #endregion
